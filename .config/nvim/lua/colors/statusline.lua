...
set_hl(0, 'St_EmptySpace', { fg = colors.base02, bg = colors.base01 })
set_hl(0, 'St_EmptySpace2', { fg = colors.base02, bg = colors.base00 })
set_hl(0, 'St_file_info', { bg = colors.base01, fg = colors.base05 })
set_hl(0, 'St_file_sep', { bg = colors.base00, fg = colors.base01 })
