...
set_hl(0, 'TelescopePromptPrefix', { fg = colors.base0F, bg = colors.black2 })
set_hl(0, 'TelescopeNormal', { bg = colors.darker_black })
set_hl(0, 'TelescopePreviewTitle', { fg = colors.base00, bg = colors.base0B })
set_hl(0, 'TelescopePromptTitle', { fg = colors.base00, bg = colors.base0F })
...
set_hl(0, 'TelescopeResultsDiffDelete', { fg = colors.base0F })
