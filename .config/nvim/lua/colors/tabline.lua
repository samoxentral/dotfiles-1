...
set_hl(0, 'TbLineBufOffDefault', { fg = colors.base05, bg = colors.base01 })
set_hl(0, 'TbLineBufOffChanged', { fg = colors.base0C, bg = colors.base01 })
set_hl(0, 'TbLineBufOffIgnored', { fg = colors.base04, bg = colors.base01 })

set_hl(0, 'TbLineBufOn', { fg = colors.base05, bg = colors.base00 })
set_hl(0, 'TbLineBufOff', { fg = colors.base04, bg = colors.base01 })

set_hl(0, 'TblineFill', { bg = colors.base01 })
set_hl(0, 'TbLineBufOnModified', { fg = colors.base0B, bg = colors.base00 })
set_hl(0, 'TbBufLineBufOffModified', { fg = colors.base0F, bg = colors.base01 })
set_hl(0, 'TbLineBufOnClose', { fg = colors.base0F, bg = colors.base00 })
set_hl(0, 'TbLineBufOffClose', { fg = colors.base04, bg = colors.base01 })
