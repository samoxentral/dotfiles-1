...
set_hl(0, 'TSAnnotation', { fg = colors.base0F })
set_hl(0, 'TSAttribute', { fg = colors.base0A })
set_hl(0, 'TSCharacter', { fg = colors.base08 })
set_hl(0, 'TSConstBuiltin', { fg = colors.base09 })
set_hl(0, 'TSConstMacro', { fg = colors.base08 })
set_hl(0, 'TSError', { fg = colors.base08 })
set_hl(0, 'TSException', { fg = colors.base08, italic = true })
set_hl(0, 'TSFloat', { fg = colors.base08 })
set_hl(0, 'TSKeywordFunction', { fg = colors.base0E, italic = true })
set_hl(0, 'TSKeywordReturn', { fg = colors.base0E, italic = true })
set_hl(0, 'TSFuncBuiltin', { fg = colors.base0D })
set_hl(0, 'TSFuncMacro', { fg = colors.base08 })
set_hl(0, 'TSKeywordOperator', { fg = colors.base0E, italic = true })
set_hl(0, 'TSMethod', { fg = colors.base0D })
set_hl(0, 'TSNamespace', { fg = colors.base07 })
set_hl(0, 'TSNone', { fg = colors.base05 })
set_hl(0, 'TSParameter', { fg = colors.base08 })
set_hl(0, 'TSParameterReference', { fg = colors.base05 })
set_hl(0, 'TSPunctBracket', { fg = colors.base0C })
set_hl(0, 'TSPunctDelimiter', { fg = colors.base0C })
set_hl(0, 'TSPunctSpecial', { fg = colors.base08 })
set_hl(0, 'TSStringRegex', { fg = colors.base0C })
set_hl(0, 'TSStringEscape', { fg = colors.base0C })
set_hl(0, 'TSSymbol', { fg = colors.base0B })
set_hl(0, 'TSTagDelimiter', { fg = colors.base0F })
set_hl(0, 'TSText', { fg = colors.base05 })
set_hl(0, 'TSStrong', { bold = true })
set_hl(0, 'TSEmphasis', { fg = colors.base09 })
set_hl(0, 'TSStrike', { fg = colors.base00, strikethrough = true })
set_hl(0, 'TSLiteral', { fg = colors.base09 })
set_hl(0, 'TSURI', { fg = colors.base09, underline = true })
set_hl(0, 'TSTypeBuiltin', { fg = colors.base0E, italic = true })
set_hl(0, 'TSVariableBuiltin', { fg = colors.base05 })
