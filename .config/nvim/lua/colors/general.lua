...
set_hl(0, 'MatchWord', { bg = colors.base02, fg = colors.base05 })

set_hl(0, 'Pmenu', { bg = colors.base01 })
set_hl(0, 'PmenuSbar', { bg = colors.base01 })
set_hl(0, 'PmenuSel', { bg = colors.base0D, fg = colors.base00 })
set_hl(0, 'PmenuThumb', { bg = colors.base02 })
...
set_hl(0, 'LineNr', { fg = colors.base02 })
...
set_hl(0, 'Substitute', { fg = colors.base01, bg = colors.base0A })
...
set_hl(0, 'Title', { fg = colors.base0D })
set_hl(0, 'Conceal', { bg = 'none' })
set_hl(0, 'Cursor', { fg = colors.base00, bg = colors.base05 })
set_hl(0, 'NonText', { fg = colors.base03 })
set_hl(0, 'SignColumn', { fg = colors.base03 })
set_hl(0, 'ColorColumn', { bg = colors.base01 })
set_hl(0, 'CursorColumn', { bg = colors.base01 })
set_hl(0, 'CursorLine', { bg = colors.base01 })
set_hl(0, 'QuickFixLine', { bg = colors.base01 })
